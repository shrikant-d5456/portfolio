...
const Compliment = () => {
    ...
    return (
        <div className='lg:w-8/12 md:w-11/12 w-full flex-col m-auto my-4 mt-[10%] text-sm lg:text-base'>
            ...
            <marquee className='w-full h-[260px] ' scrollamount="2" direction="left" >
                <div className='w-full flex gap-8   '>

                    {Compliments.map((ele) => (
                        <JackInTheBox >
                            <div key={ele.id}  className='anime w-[400px] mx-4 bg-gradient-to-br from-cyan-100 via-transparent to-cyan-100 shadow-2xl dark:border-[1px]  rounded-br-3xl rounded-t-3xl  border-white px-6 py-4'>
