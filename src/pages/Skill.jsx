            ...
            <div className='w-full flex gap-8  '>
              {
                skillData.map((img, index) => (
                  <i key={index} className=' lg:w-[100px] lg:h-[100px] w-[60px] h-[60px] rounded-full hover:shadow-4xl hover:shadow-[#e299ff99]  '><img
                    className='lg:w-[100px] lg:h-[100px] w-[60px] h-[60px] rounded-full border-2 lg:border-[4px] dark:border-[#e299ff99]  border-[#a8efff] lg:p-2 p-1'
          ...
          skillData.slice(0, lenght).map((element, index) => (
            <Slide direction="up" triggerOnce>
              <div key={element.id} className='flex-col'>
                <span className='w-[100px]  ml-10 lg:ml-14 border-[1px] dark:border-[#e299ff99]  border-[#a8efff] rotate-90'></span>

                <div className='overflow-hidden w-full lg:flex flex-row justify-center items-center '>
                  <div className='lg:w-[130px] lg:h-[110px]  w-[80px] h-[80px] rounded-full shadow-md dark:border-[#e299ff99] border-[#a8efff] border-2 p-1 '>
                  ...
                  <span className='w-20 lg:ml-0 ml-10 border-[1px] dark:border-[#e299ff99] border-[#a8efff]'></span>

                  <div className='border w-full blur-card dark:bg-gradient-to-r from-violet-200 to-pink-200 dark:border-none border-[#a8efff] text-center p-2 rounded-sm '>
